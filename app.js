...
const calculationCalculators = document.getElementById("calculations-calculator")
...
document.getElementById('calculate-btn').addEventListener('click', () => {
    ...
    if (isValid) {
        ...
        calculationCalculators.classList.add('show')
        ...
        calculationCalculators.classList.remove('show')
    }
})
...
document.getElementById('clear-btn').addEventListener('click', () => {
    ...
    document.querySelectorAll('.form-flex').forEach(ele => {
